...
0xE8,RELOC,                         // 00AF CALL $entity_setpos
...
codedef icon_code[] = {
    ...
    CODE(KEY_NOCOLL, code_key_nocoll, reloc_key_nocoll),
    CODE(KEY_SEEALL, code_key_seeall, reloc_key_seeall),
